function getDefaultExportFromCjs(x) {
  ...
  var readCodePoint = lib.readCodePoint;
  var readInt = lib.readInt;
  var readStringContents = lib.readStringContents;
  export {lib as __moduleExports, readCodePoint, readInt, readStringContents};
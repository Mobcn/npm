import _t from "./types@v7.21.2.js";
...
var importBuilder = createCommonjsModule(function(module, exports) {
  ...
  class ImportBuilder {
    ...
    namespace(name = "namespace") {
      ...
      assert$1.assert(statement.type === "ImportDeclaration");
      assert$1.assert(statement.specifiers.length === 0);
    ...
    var(name) {
      ...
      if (statement.type !== "ExpressionStatement") {
        assert$1.assert(this._resultName);
    ...
    _interop(callee) {
      ...
      if (statement.type === "ExpressionStatement") {
        ...
        assert$1.assert(statement.declarations.length === 1);
...
var importInjector = createCommonjsModule(function(module, exports) {
  ...
  class ImportInjector2 {
    ...
    addNamed(importName, importedSourceIn, opts) {
      assert$1.assert(typeof importName === "string");
    ...
    _applyDefaults(importedSource, opts, isInit = false) {
      ...
      if (typeof importedSource === "string") {
        ...
        assert$1.assert(!opts, "Unexpected secondary arguments.");
    ...
    _generateImport(opts, importName) {
      ...
      const isMod = (0, isModule_1.default)(this._programPath);
      const isModuleForNode = isMod && importingInterop === "node";
      const isModuleForBabel = isMod && importingInterop === "babel";
      if (importPosition === "after" && !isMod) {
        throw new Error(`"importPosition": "after" is only supported in modules`);
      }
      const builder = new importBuilder.default(importedSource, this._programScope, this._hub);
      if (importedType === "es6") {
...
var lib = createCommonjsModule(function(module, exports) {
  ...
  Object.defineProperty(exports, "isModule", {
    enumerable: true,
    get: function() {
      return isModule_1.default;
    }
  });
  function addDefault2(path, importedSource, opts) {
    return new importInjector.default(path).addDefault(importedSource, opts);
  }
  function addNamed2(path, name, importedSource, opts) {
    return new importInjector.default(path).addNamed(name, importedSource, opts);
  }
  function addNamespace2(path, importedSource, opts) {
    return new importInjector.default(path).addNamespace(importedSource, opts);
  }
  function addSideEffect2(path, importedSource, opts) {
    return new importInjector.default(path).addSideEffect(importedSource, opts);
  }
});
var __pika_web_default_export_for_treeshaking__ = /* @__PURE__ */ getDefaultExportFromCjs(lib);
var ImportInjector = lib.ImportInjector;
var addDefault = lib.addDefault;
var addNamed = lib.addNamed;
var addNamespace = lib.addNamespace;
var addSideEffect = lib.addSideEffect;
export default __pika_web_default_export_for_treeshaking__;
var isModule = lib.isModule;
export {ImportInjector, lib as __moduleExports, addDefault, addNamed, addNamespace, addSideEffect, isModule};